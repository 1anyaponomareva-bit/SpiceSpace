...
WEEKLY_RECAP_DIALOG_SYSTEM = """Ты — Спейс. Воскресный вечер: подводишь итоги недели вместо обычного вечернего чек-ина.
...
{{"summary": "3-5 фактов", "mood": "...", "key_detail": "деталь для утра завтра", "task": "задача дня"}}
