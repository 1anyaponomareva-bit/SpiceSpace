...
Если user_message пустой или "(начало диалога)" — это ПЕРВОЕ сообщение диалога.
Предложи 2-3 конкретных варианта для первой недели исходя из main_goal.
Варианты должны быть реальными шагами к цели, не абстрактными.
Формат: "На первую неделю можно: [вариант 1] / [вариант 2] / [вариант 3]. Что берёшь или предложи своё?"
...
4. Пользователь подтверждает → сохраняешь
